      ...
      <main className="mx-auto max-w-2xl px-5 py-12">
        ...
        <div className="mt-6 space-y-5 text-base leading-relaxed" style={{ color: "var(--muted)" }}>
          <p>
            ...
            מסתתרת בעיה: על כל מנה, המסעדה מפרישה לפלטפורמה נתח גדול - עמלות שמדווחות לא פעם בעשרות
            אחוזים. בסוף, גם אנחנו משלמים יותר, וגם המסעדות הקטנות נחנקות.
          </p>
          <p>
            בניתי את ישיר לבד, בזמני הפנוי ובלי רקע פורמלי בתכנות, מתוך אמונה פשוטה שאפשר אחרת. ישיר
          ...
          <p>
            אני לא גובה שקל מאף אחד, וזו לא עוד פלטפורמת משלוחים. זה פרויקט קטן ואישי, מתוך רצון להחזיר
            קצת הוגנות לדרך שבה אנחנו מזמינים אוכל - גם בשביל המסעדות, וגם בשבילנו.
          </p>
          <p>אם יש מסעדה ששווה להוסיף, אם משהו לא עובד, או סתם בא לכם להגיד שלום - אשמח לשמוע.</p>
        </div>
